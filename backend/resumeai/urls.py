...
urlpatterns = [
    ...
    path("resumes/<uuid:resume_id>/pdf-as-html/", ResumePdfToHtmlAPI.as_view()),
    path("resumes/<uuid:resume_id>/save-pdf/", ResumeSavePdfAPI.as_view()),
    path("export-pdf/", ExportPdfAPI.as_view()),
